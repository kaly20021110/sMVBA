...
func NewSPBProposal(Author core.NodeID, B *ConsensusBlock, Epoch, Round int64, Phase int8, sigService *crypto.SigService) (*SPBProposal, error) {
...
func (own *SPBProposal) Module() string {
	return "consensus"
}
